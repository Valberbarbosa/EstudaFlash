        ...
        <aside class="aside-menu">
            ...
            <div class="aside-diretorio">
                ...
                <ul>
                    ...
                    <li><a href="#"><i class="fas fa-sitemap"></i><span>Explore</span></a></li>
                            ...
                            <div class="dashboard-card-conteudo dashboard-card-conteudo-aprender">
                                ...
                                <div class="dashboard-card-input">
                                    <fieldset>
                                        ...
                                        <input type="text" placeholder="Digite a resposta" name="resposta" id="resposta">
                                    </fieldset>
                                    <div class="dashboard-card-input-btn">
                                        <div class="dashboard-card-input-btn-right">
                                            <button>Não sabe?</button>
